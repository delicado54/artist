...
?>
	<ul id="filter">
		...
		//print_r($cats);
		foreach($cats as $cat):			
		?><li><a href="#grid" data-group="<?php echo $cat->name; ?>"<?php if(isset($_GET['c']) && $_GET['c']== $cat->name):?> class="active"<?php endif; ?>><?php echo $cat->name; ?><?php //echo $cat->description; ?></a></li>
		<?php endforeach; ?>
		</ul>	
